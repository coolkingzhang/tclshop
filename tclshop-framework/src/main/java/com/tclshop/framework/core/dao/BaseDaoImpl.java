package com.tclshop.framework.core.dao;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import com.tclshop.framework.core.mybatis.interceptor.ExecutorInterceptor;
import com.tclshop.framework.entity.BaseEntity;
import com.tclshop.framework.exceptions.BizException;
...
public abstract class BaseDaoImpl<T extends BaseEntity> extends SqlSessionDaoSupport implements BaseDao<T> {
	...
	public int update(T entity) {
		System.out.println("SQL:"+getStatement(SQL_UPDATE).toString());
