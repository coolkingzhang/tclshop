package com.tclshop.framework.core.mybatis.cache.redis;
...
import com.tclshop.utils.cache.redis.SerializeUtil;
 ...
 * <cache eviction="LRU" type="tclshop.common.core.mybatis.cache.redis.MybatiesRedisCache" />
...
public class RedisCache implements Cache {
	...
	public Object getObject(Object key) {
		...
		try {
			...
			System.out.println(SerializeUtil.serialize(key.hashCode()));
			System.out.println(jedis.get(SerializeUtil.serialize(key.hashCode())));
