...
public class RecruitmentController {
    ...
    public String index(
        ...
        try {
            ...
            model.addAttribute("empDevelopment", findGlobalList(3, 1, 1));// type为3是员工发展信息
            model.addAttribute("empLife", findGlobalList(4, 1, 1));// type为4是员工生活信息
            model.addAttribute("campusRecruitment", findGlobalList(5, 1, 1));// type为5是校园招聘信息
            model.addAttribute("socialRecruitment", findGlobalList(6, 1, 1));// type为6是社会招聘信息
        } catch (Exception e) {
