...
public class CompanyInfoController {
    ...
    */
    ...
    public String userProvision() {
        return "company/terms_service";
    }

    /* 隐私保护  */
    @RequestMapping(value = "/privacyProtection", method = RequestMethod.GET)
    public String privacyProtection() {
        return "company/privacy_protection";
    }

    /* 法律申明 */
    @RequestMapping(value = "/legalNotices", method = RequestMethod.GET)
    public String legalNotices() {
        return "company/legal_notices";
    }

    /* 成员网站 */
    @RequestMapping(value = "/memberSite", method = RequestMethod.GET)
    public String memberSite() {
        return "company/member_site";
    }
}
