        ...
        <div id="main" class="main">
            ...
            <header class="rct_banner ivsr" style="background: url(${pictureFont[0].webPic}) no-repeat;background-size: cover;">
                <p class="rct_banner_text fs34">
                    <a href="javascript:void(0);">
                        <span class="lftext fs32">为股东创造效益</span>
                        <span class="lftext fs22">股票代码: 000100.SZ</span>
                    </a>
                </p>
            </header>
            ...
            <div class="layout cut_space">
                <div class="about_nav y_w92">
                    <ul class="about_nav_s1 fs24 bor-bott ivsr_list rj_nav">
                        <li class="liw192" data-type="${analysis.data.manageReport.records[0].type }" data-maxPage="${analysis.data.manageReport.pages }" class="active">
                            <a href="javascript:void(0);">定期经营分析报告</a>
                        </li>
                        <li class="liw192" data-type="${analysis.data.publicCompanyReport.records[0].type }" data-maxPage="${analysis.data.publicCompanyReport.pages }">
                            <a href="javascript:void(0);">上市公司报告</a>
                        </li>
                        <li class="liw192" data-type="${analysis.data.investmentReport.records[0].type }" data-maxPage="${analysis.data.investmentReport.pages }">
                                ...
                                <a href="${manageReport.url }">
                                    <dl class="file_cell">
                                        <dd class="file_cell_left">
                                            <img src="${pageContext.request.contextPath }/static/common/images/pdficon.png" alt=""/>
                                        </dd>
            ...
            <div class="layout">
                <div class="y_w92">
                    ...
                    <ul class="ivsr_imgs">
                        <li>
                            <a href="http://multimedia.tcl.com/cn/investor/main.do?method=listing&amp;mappingName=IR_Financial">
                                <img src="${pageContext.request.contextPath }/static/common/images/TCL多媒体.png" alt=""/>
                            </a>
                        </li>
                        <li>
                            <a href="http://www.tclcom.com/?page=financials">
                                <img src="${pageContext.request.contextPath }/static/common/images/TCL通讯.png" alt=""/>
                            </a>
                        </li>
                        <li>
                            <a href="http://www.tonlyele.com/channel.aspx?id=69">
                                <img src="${pageContext.request.contextPath }/static/common/images/通力电子.png" alt=""/>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="y_w92">
                    <div class="rct_campus abreast fs24 bor-bott">
                        <a href="${pageContext.request.contextPath }/investors/investorsQA?id=5">
                            ...
                            <span class="abreast_text emo1 color_999">更多
                                <span class="icf">&#xe62f;</span>
                            </span>
                        </a>
                    </div>
                    <div>
                        <ul class="QNA_list fs30">
            ...
            <div class="layout cut_space">
                <div class="about_nav y_w92">
                    <ul class="about_nav_s1 fs24 bor-bott ivsr_list ivsr_notc rj_nav">
                        <li class="liw192" data-type="${lawAndBbs.data.publicCompanyManger.records[0].type }" data-maxPage="${lawAndBbs.data.publicCompanyManger.pages }" class="active">
