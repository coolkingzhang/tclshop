        ...
        <div id="main" class="main">
            ...
            <div class="layout cut_space">
                <div class="y_w92">
                    ...
                    <section class="pictext_news">
                        <ul class="img_list">
                            <li>
                                <img src="${pageContext.request.contextPath }/static/common/images/TCL工艺基金会.png" alt=""/>
                            </li>
                        </ul>
                        <p class="fs22">
            ...
            <div class="layout cut_space">
                <div class="y_w92">
                    ...
                    <section class="pictext_news">
                        <!-- 最大字符数为95 -->
                        <p class="fs22">“TCL希望工程烛光奖”由深圳市TCL公益基金会和中国青少年发展基金会联合发起，项目计划五年投入2500万元，用于表彰和鼓励在一线爱岗敬业严守师道的优秀乡村教师，从而改善...<a class="pictext_news_detaile" href="http://gyjj.tcl.com/frmsubject.aspx">查看全部>></a>
                        </p>
                        <ul class="img_list">
                            <li class="b50">
                                <img src="${pageContext.request.contextPath }/static/common/images/希望工程烛光.png" alt=""/>
                                <img src="${pageContext.request.contextPath }/static/common/images/希望工程烛光-01.png" alt=""/>
                            </li>
                        </ul>
                    </section>
                </div>
