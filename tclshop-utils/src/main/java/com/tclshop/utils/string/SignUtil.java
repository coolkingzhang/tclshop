package com.tclshop.utils.string;
...
public class SignUtil {
	...
	public static String buildRequestMysign(Map<String, String> sPara, String key) {
		String prestr = SignUtil.createLinkString(sPara); // 把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串
		String mysign = "";
		if (SignUtil.sign_type.equals("MD5")) {
			mysign = SignUtil.sign(prestr, key, SignUtil.input_charset);
		}
		return mysign;
	}
