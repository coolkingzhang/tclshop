...
<div class="box relative" style="border:none;">
    ...
    <div class="absolute sosial-text">
        ...
        <p class="sosial-text-detail"> ${pictureFont.records[0].shorttile }</p>
...
<div class="sosial-box">
    <div class="title pr">企业公民活动<p class="border_botm"></p></div>
    <div class="sosial-list">
        <c:forEach items="${activity}" var="act">
            <dl>
                <dt class="fl">
                    <a href="${pageContext.request.contextPath}/societyDuty/societyDutyDetail?id=${act.id}&type=${act.type}" target="_blank"><img class="media-pic" src="${act.pic}"/></a>
                </dt>
                <dd class="fl">
                    <div class="font">
                    <a href="${pageContext.request.contextPath}/societyDuty/societyDutyDetail?id=${act.id}&type=${act.type}" target="_blank">
...
<div class="box marTop fund">
    <div class="sosial-box">
        <p class="hyjj_title"><a href="javascript:void(0);" class="hover hm-nav-js">华萌基金</a><a href="javascript:void(0);" class="hm-nav-js">志愿者风采</a></p>
...
<div class="box">
    <div class="sosial-box">
        <div class="title pr">企业社会责任报告 <p class="border_botm"></p></div>
        <div class="social-blame">
            <dl>
                <dt class="fr social-blame-img"><img src="${pageContext.request.contextPath}/static/img/sosialItem04.jpg"/></dt>
                <dd class="fl">
                    <p class="content">
                    	${duty.content}
                    </p>
...
<div class="box" style="margin-bottom:0">
    <div class="sosial-box marTop">
        <div class="award">
            <div class="font pr">TCL希望工程烛光奖 <p class="border_botm"></p></div>
            <div class="content">
	...
	<div class="social_code">
		<ul class="code_content">
			<li>
				<h3>TCL公益基金会微博</h3>
				<div class="social_content_img">
					<a href="http://www.weibo.com/tclgongyi">
						<img src="${pageContext.request.contextPath }/static/img/QRcode_tclFund.png">
					</a>
					<p>扫描关注TCL公益基金会</p>
				</div>	
			</li>
			<li>
				<h3>华萌基金微博</h3>
				<div class="social_content_img">
					<a href="http://www.weibo.com/huameng2007">
						<img src="${pageContext.request.contextPath }/static/img/QRcode_hmFund.png">
					</a>
					<p>扫描关注华萌基金</p>
				</div>	
			</li>
			<li>
				<h3>TCL集团微信号</h3>
				<div class="social_content_img">
					<img src="${pageContext.request.contextPath }/static/img/QRcode_tcl.png">
					<p>扫描关注集团微信号</p>
				</div>	
			</li>
		</ul>
