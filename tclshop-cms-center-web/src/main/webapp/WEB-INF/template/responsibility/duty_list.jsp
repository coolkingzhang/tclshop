...
<div class="crumbs">
    <div class="main"><a href="${pageContext.request.contextPath }/index" target="_blank">集团官网</a> &gt;<a href="${pageContext.request.contextPath}/societyDuty/index">企业社会责任</a> &gt; <a href="#">社会责任报告</a></div>
</div>
<div class="gmxd_content" id="Searchresult">
    <c:forEach items="${result.records}" var="obj">
        <ul class="huameng">
            <li class="font">
                <a target="_blank" href="${obj.pic}">${obj.title}</a>
                <i>
...
<script id="currentPage" data-targetpage="socialDutyList"
