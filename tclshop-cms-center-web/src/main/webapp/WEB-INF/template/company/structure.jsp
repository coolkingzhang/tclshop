...
<body>
	...
	<div class="about_TCL_top">
		<div class="about_TCL_nav">
			<ul>
				<li><a href="${pageContext.request.contextPath }/companyInfo/index" target="_blank">关于TCL</a></li>
				<li><a href="${pageContext.request.contextPath }/companyInfo/companyInfoArch" target="_blank" class="hover">公司架构</a></li>
	...
	<div id="li_jiagou_1" class="li_jiagou_1" >
		...
		<ul>
			...
			<li>
				<div class="li_pos_b">
					<img  src="${pageContext.request.contextPath }/static/img/li_jiagou_tu3.jpg" alt="架构图片">
	...
	<div id="li_jiagou_2" class="li_jiagou_2">
	...
	<div id="li_jiagou_3" class="li_jiagou_3">
