	...
	<div class="about_TCL_top2 li_yanfa_bj" style="background: url(${pictureFont.records[0].webPic }) center top no-repeat #fff;">
		<div class="about_TCL_nav2">
			<ul>
				...
				<li><a href="${pageContext.request.contextPath }/companyInfo/companyInfoRDev" class="hover" target="_blank">技术研发</a></li>
			</ul>
		</div>
      ...
      <div class="li_guanyu_1_b bj_none">     
     	<div class="li_about_f">
			...
			<p class="f_center pt30">
				<a href="${pageContext.request.contextPath }/companyInfo/companyInfoPagingList?type=19" target="_blank">查看更多 >></a>
            </p>
		</div>				
	</div>
