	...
	<div class="invest box talent-box">
		...
		<ul class="talent-list">
			<li class="talent-item">
				...
				<p class="title">校园招聘</p>
				<p class="text">
					${campusRecruitment.records[0].description }
				</p>
				<p ><a href="${pageContext.request.contextPath }/recruitment/recruitmentDetails?id=${campusRecruitment.records[0].id}"> 了解更多>> </a></p>
			</li>
			<li class="talent-item">
				<p class="ifont talent-b">&#xe647;</p>
				<p class="title">社会招聘</p>
				<p class="text">
			     	${socialRecruitment.records[0].description }
				</p>
				<p ><a href="${pageContext.request.contextPath }/recruitment/recruitmentDetails?id=${socialRecruitment.records[0].id}"> 了解更多>> </a></p>
			</li>
			<li class="talent-item">
				...
				<p class=""><a href="${pageContext.request.contextPath }/recruitment/recruitmentDetails?id=${empDevelopment.records[0].id}"> 了解更多>> </a></p>
			</li>
			<li class="talent-item">
				...
				<p ><a href="${pageContext.request.contextPath }/recruitment/recruitmentDetails?id=${empLife.records[0].id}"> 了解更多>> </a></p>
			</li>
		</ul>
	</div>
		...
		<table class="talent-list talent-tab" cellpadding="0" cellspacing="0" id="Searchresult">
			...
			<c:forEach items="${job.records }" var="obj">
			   <tr>
				...
				<td><a href="${obj.url }" class="submit">我要应聘</a></td>
			</tr>
			</c:forEach>
		</table>
