    ...
    <div class="fxbg tabContent-js" id="zyz_1">
      <ul>
         <c:forEach items="${indexData.one }" var="records1" begin="0" end="5">
  		 	<li><a href="${records1.url }" target="_blank">${records1.title }</a> <a href="${records1.url }" target="_blank"><i>PDF下载</i></a></li>
  		</c:forEach> 
    ...
    <div class="fxbg tabContent-js" id="zyz_2" style="display:none">
      <ul>
     	<c:forEach items="${indexData.two }" var="records2">
     		<li><a href="${records2.url }" target="_blank">${records2.title }</a><a href="${records2.url }" target="_blank"> <i>PDF下载</i></a></li>
     	</c:forEach>
      </ul>
    ...
    <div class="fxbg tabContent-js" id="zyz_3" style="display:none">
      <ul>
     	<c:forEach items="${indexData.three }" var="records3">
     		<li><a href="${records3.url }" target="_blank">${records3.title }</a><a href="${records3.url }" target="_blank"><i>PDF下载</i></a></li>
     	</c:forEach>
      </ul>
...
<div class="sub_company_box">
  ...
  <div class="invest-main invest-mar pr">
    ...
    <div class="ticker_a"><div class="ticker_b pa"></div><p class="ticker_c pa"><span class="exc_rate1">TTK家电</span><span class="exc_rate2">02618.HK</span></p></div>
    <p class="invest-p">公司创立于1981年，前身为中国首批13家合资企业之一——TTK家庭电器（惠州）有限公司，从事录音磁带的生产制造，后来拓展到电话、电视、手机、冰箱、洗衣机、空调、<br />
  ...
  <div class="invest-main invest-mar pr">
    ...
    <p class="invest-p">全球领先的移动终端产品和互联网服务提供商TCL通讯科技控股有限公司（简称“TCL通讯”，股票代码：HK.2618）成立于1999年3月是TCL集团旗下核心产业之一。TCL通讯总部位于<br />
中国深圳，其产品和服务销往全球170多个国家和地区，全球雇员达15,000多名。
 ...
 <div class="invest-main invest-mar pr">
    ...
    <div class="ticker_a02"><div class="ticker_b02 pa"></div><p class="ticker_c02 pa"><span class="exc_rate1">通力電子</span><span class="exc_rate2">02618.HK</span></p></div>
    <p class="invest-p">通力電子控股有限公司（HK：1249）致力于成为全球领先、具有产业竞争力的音视频产品ODM供应商。通力电子专注于电声技术和新媒体技术的开发和应用，快速实现高性价<br />
...
<div class="laws_reg_box">
  ...
  <div class="laws_reg">   
    ...
    <div class="laws tabContent1-js" id="flfg_2" style="display:none">
      ...
      <div class="seemore"><a href="TCL证券法律法规" target="_blank">查看更多>></a></div>
    </div>
