...
<body>
	...
	<div class="about_TCL_top2" style="background-image:url(${pictureFont.records[0].webPic })">
		<div class="about_TCL_nav2">
			<ul>
				<li><a href="${pageContext.request.contextPath }/companyInfo/index" class="hover">关于TCL</a></li>
	...
	<div class="li_guanyu_1_b">
				<div class="li_guanyu_1">
						...
						<div class="line"></div>
						<p class="li_jieshao f14">TCL即 the creative life 三个英文单词首字母的缩写，意为创意感动生活。<br><br>

				公司创立于1981年，前身为中国首批13家合资企业之一——TTK家庭电器（惠州）有限公司，从事录音磁带的生产制造，后来拓展到电话、电视、<br><br>

				手机、冰箱、洗衣机、空调、小家电、液晶面板等领域。集团现有7.5万名员工，23个研发机构，21个制造基地，在80多个国家和地区设有销售机<br><br>

				构，业务遍及全球160多个国家和地区。</p>
						<p class="f14 f_center pt20"><a href="${pageContext.request.contextPath }/companyInfo/slipPath?type=1">查看更多</a></p>
	  </div>
...
<a href="${pageContext.request.contextPath }/companyInfo/developList">查看更多 >></a>
                            </p>
						</div>
	</div>
		...
		<div class="title">企业荣誉</div>
			...
			<ul class="wrap_2">
				<li>
					...
					<p class="t">${honor[0].years} _______</p>
						${honor[0].content }
				</li>
				<li>
				<img src="${honor[1].pic }" alt="企业荣誉">
				<p class="t">${honor[1].years} _______</p>
					${honor[1].content }
				</li>
				<li class="none">
				<img src="${honor[2].pic }" alt="企业荣誉">
				<p class="t">${honor[2].years} _______</p>
					${honor[2].content }
				</li>
			</ul>
			<p class="f_center pt30">
